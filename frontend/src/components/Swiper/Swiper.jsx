                ...
                >
                    {categories.map((category, i) => (
                        <SwiperSlide> <div className="swiper-slide rounded-lg">
                            <a href={`${URL}/shop/${category.tag_ct}`} className="lg:h-[240px] block w-[80px] h-[120px] lg:w-[160px] text-center pt-5">
                                <img src={`http://localhost:3000/images/${category.image_ct}`} alt="" className="mb-2 lg:h-[160px] h-[80px] lg:w-[160px] rounded-full object-cover w-[80px] hover:scale-[1.05]" style={{ transition: '1s' }} />
